...
class SeriesViewController: UITableViewController {
    ...
    @objc func legalInfoButtonPressed() {
        ...
        let alert = UIAlertController(title: "Terms and Conditions", message: "By installing this application, the user agrees to the following Terms and Conditions. This application is intended for recreational use only. Any and all card series featured in this application are the registered trademarks of their respective creators or owners. The creator of this application does not guarantee that any pre-installed series, decks, or cards are accurate of free of error. The end user is responsible for any data (text, photographic and otherwise) added to the application or modified by the user. The creator of this application is not responsible for any illegal use of said application. Although all reasonable effort has been made to create and maintain this application to be fully functional, the creator of said application does not guarantee future updates to, or maintenance of, the application or compatibility with future iOS software versions or updates. The creator of this application is not responsible for any harm to self, others, of property incurred while using, or due to the use of, this application. This application is provided on an \"As Is\" basis.", preferredStyle: .alert)
